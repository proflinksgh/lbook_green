...
class amwork_controller extends route
{
  ...
  { 
    ...
    $msg = array();
    $result = $db->getAllData("SELECT * from loan_tb WHERE CCODE=".$_COOKIE["ccode"]." AND STATUS=3");
    if($result !==0 ){
    foreach($result as $row)
        {
          ...
          $status="<i class='read'>Complete</i>";
