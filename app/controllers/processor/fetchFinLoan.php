...
class amwork_controller extends route
{
  ...
  { 
    ...
    $msg = array();
    $result = $db->getAllData("SELECT * from loan_tb WHERE CCODE=".$_COOKIE["ccode"]." AND REPAY_STATUS=0");
    if($result !==0 ){
