       ...
       function fetch_product()
        ...
        if($this->rate !=0 && $this->product_id == 2){
           ...
           // echo "Amount: ".$amount;
            ...
            $query = "INSERT INTO interest_tb (PRODUCT_ID, ACCOUNT_NUMBER, ACCRUE_STATUS, YEAR, MONTH, AMOUNT, DATE_CREATED, CCODE, HCODE) VALUES ('$this->product_id', '$this->account_no', '0', '$year', '$month', '$amount', '$currDate', '$ccode', $db->hcode())";
