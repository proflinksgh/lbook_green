  ...
  <div class="content-wrapper">
    ...
    <div class="container-fluid">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Loan Applicants</li>
      </ol>  
      <div class="card mb-3">
        <div class="card-header">        
          <i class="fa fa-table"></i> All Loan Applicants</div>
            <div align="right" style="margin-top:1%">
           <a href="loan_account" class="btn btn-primary medium"><i class="fa fa-user-plus"></i> Register New</a> 
           <a href="#" class="btn btn-danger medium delUser"><i class="fa fa-remove"></i> Delete</a>
           </div>
        <div class="card-body">
