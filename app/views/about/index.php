    ...
    <main>
        ...
        <div class="breadcrumb__area breadcrumb-space theme-bg-1 valign p-relative z-index-11 fix">
            ...
            <div class="round__shape">
                <img src="assets/landing/images/cercle.png" alt="image not found">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xxl-6 col-xl-6 col-lg-8">
                        <div class="breadcrumb__title-wraper">
                            ...
                            <h2 class="breadcrumb__title wow fadeIn" data-wow-delay=".5s">Empowering Financial Business: <span class="gradient-text-3">Welcome to L-BOOK Fintech.</span></h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row gy-50 align-items-center">
                    <div class="col-xxl-6 col-xl-6 col-lg-6">
                        <div class="mission__thumb wow fadeInLeft animated" data-wow-delay=".6s">
                            <img src="assets/landing/images/mission-light.png" alt="image not found">
                        </div>
                    </div>
                    <div class="col-xxl-6 col-xl-6 col-lg-6">
                        <div class="mission__content wow fadeInRight animated" data-wow-delay=".6s">
                            ...
                            <p>Developing cutting-edge financial technology solutions to simplify processes, enhance user experiences, and keep pace with evolving trends in the financial sector.</p>
                            <p>L-Book is designed to enhance financial processes by offering software solutions that streamline workflows, automate repetitive tasks, and improve overall efficiency of financial businesses.</p>
                            <div class="btn__wrapper">
                                <a class="bd-gradient-btn" href="onboard">Begin Free Trial<span><i class="fa-regular fa-angle-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="revolution__grid">
                        ...
                        <div class="revolution__item text-center is-mainly-pink">
                            <div class="revolution__content">
                                ...
                                <p>Enjoy the smooth experience</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xxl-5 col-xl-5 col-lg-5">
                        <div class="our-values__content-wrapper wow fadeIn" data-wow-delay=".3s">
                            <div class="section__title-wrapper">
                                ...
                                <h2 class="section__title mb-20">Our Commitment to your growth</h2>
                            </div>
                            <p class="mb-0">We recognize that customer satisfaction is an integral part of a viable brand.</p>
                            <div class="btn__wrapper">
                                <a class="bd-gradient-btn" href="onboard">Get started<span><i class="fa-regular fa-angle-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="our-values__item is-mainly-red wow fadeIn" data-wow-delay=".5s">
                                    <div class="our-values__icon">
                                        <span>
                                 <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M19.6895 13.7992H25.5451V40H19.6895V13.7992Z" fill="white"></path>
                                    <path d="M3.29102 29.6122H9.14664V40H3.29102V29.6122Z" fill="white"></path>
                                    <path d="M11.4902 21.7057H17.3458V40H11.4902V21.7057Z" fill="white"></path>
                                    <path d="M30.5242 0L24.3398 6.18438H27.8888V40H33.1597V6.18438H36.7086L30.5242 0Z" fill="white"></path>
                                 </svg>
                              </span>
                                    </div>
                                    <div class="our-values__content">
                                        <h3>Innovation</h3>
                                        <p>Improved technology for significant advancement</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="our-values__item is-mainly-blue wow fadeIn" data-wow-delay=".7s">
                                 ...
                                 <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="our-values__content">
                                        <h3>Keep growing</h3>
                                        <p>Ensuring growth & sustainability</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="swiper team__carousel-active">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="team__item text-center">
                                            <div class="team__thumb">
                                                <img src="assets/landing/images/01.png" alt="image not found">
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="team__item text-center">
                                            <div class="team__thumb">
                                                <img src="assets/landing/images/02.png" alt="image not found">
                                            </div>
                                            <div class="team__contenrt">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="team__item text-center">
                                            <div class="team__thumb">
                                                <img src="assets/landing/images/03.png" alt="image not found">
                                            </div>
                                            <div class="team__contenrt">
                                ...
                                <div class="common__nav-pre pagination__wrappper">
                                    <div class="common__navigation">
                                        <button class="common__slider-button-prev"><i class="fa-regular fa-angle-left"></i></button>
                                        <div class="why__choos-pagination">
                                            <div class="bd-swiper-dot text-center"></div>
                                        </div>
                                        <button class="common__slider-button-next"><i class="fa-regular fa-angle-right"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row gy-50 justify-content-center wow fadeIn" data-wow-delay=".3s">
                    <div class="col-xxl-6 col-xl-6 col-lg-6">
                        <div class="finance__content">
                            ...
                            <div class="btn__wrapper">
                                <a class="bd-gradient-btn" href="about-light.html">Know More<span><i class="fa-regular fa-angle-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-6 col-xl-6 col-lg-6">
                        <div class="finance__map-wrapper p-relative ">
                            <div class="finance__map-bg">
                                <img src="assets/landing/images/map-bg.png" alt="image not found">
                            </div>
                                        ...
                                        <div class="location__info">
                                          ...
                                          <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="lacation__link">
                                                <a class="lacation__btn" href="#"><span><i class="fa-regular fa-arrow-right"></i></span>Get Direction</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
