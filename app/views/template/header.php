...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <?php if($page_parse == "auth"||$page_parse == 'activation') {
      page_css('login/bootstrap.min.css');
      page_css('login/style.css');
      page_css('login/vendors.css');
      page_css('login/icon_fonts/css/all_icons.min.css');
      page_css('login/custom.css');
    }else{
