    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">        
          <i class="fa fa-table"></i> STAFF DEDUCTION SHEET </div>
          <div align="right" style="margin-top:1%">
           <a href="#" class="btn btn-primary medium" id="idNewDeduction"><i class="fa fa-user-plus"></i> Add New Deduction </a> 
           <a href="#" class="btn btn-success medium" id="idUpdateDeduction"><i class="fa fa-pencil-square-o"></i> Edit</a>
           <a href="#" class="btn btn-danger medium" id="idDeleteDeduction"><i class="fa fa-remove"></i> Delete</a>
           </div>
        <div class="card-body">
